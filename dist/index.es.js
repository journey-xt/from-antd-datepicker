...
(function (global, factory) {
    ...
    function offsetFromString(matcher, string) {
        ...
        chunk$$1 = matches[matches.length - 1] || [];
        parts = (chunk$$1 + '').match(chunkOffset) || ['-', 0, 0];
...
var PackTag = /** @class */function (_super) {
    ...
    PackTag.prototype.render = function () {
        var _a = this.props,
            ...
            checked = _a.checked,
            disabled = _a.disabled;
        return React.createElement(PackLayoutTag, { checked: checked, disabled: disabled, onChange: this.handleOnChange }, children);
    };
    return PackTag;
}(PureComponent);
...
var PopoverRender = /** @class */function (_super) {
    ...
    PopoverRender.prototype.render = function () {
        ...
        var _a = this.props,
            rownum = _a.rownum,
            value = _a.value;
        var chunkRownum = chunk(rownum, 5);
        return React.createElement(Warp, null, chunkRownum.map(function (item, index) {
            return React.createElement(RowTagWarp, { key: index }, item.map(function (tag) {
                return React.createElement(PackTag, { key: tag.value, tags: tag, disabled: tag.disabled, checked: Number(value) === Number(tag.value), onChange: _this.handleOnChange }, tag.value);
            }));
        }));
    };
...
var TimeInput = /** @class */function (_super) {
    ...
    function TimeInput(props) {
        ...
        _this.inputEle = React.createRef();
        _this.state = {
            visible: false
        };
        return _this;
    ...
    TimeInput.prototype.render = function () {
        ...
        return React.createElement(PackPopover, { trigger: "click", mouseEnterDelay: 50, mouseLeaveDelay: 0, visible: visible, getPopupContainer: function (triggerNode) {
                return triggerNode;
            }, autoAdjustOverflow: true, onVisibleChange: this.onVisibleChange, overlayStyle: { padding: "12px 4px" }, content: React.createElement(PopoverRender, __assign({}, reset, { value: value, rownum: rownum, onChange: this.tagOnClick })), placement: format === "HH" ? "topLeft" : "top" }, React.createElement(InputWarp, null, React.createElement(_Input, { ref: this.inputEle, value: value, onChange: this.handleChange, onFocus: this.onFocus, onPressEnter: this.onPressEnter })));
    };
    return TimeInput;
}(PureComponent);
...
var TimePicker = /** @class */function (_super) {
    ...
    function TimePicker(props) {
        ...
        // 返回分隔符号
        _this.splitSymbol = memoize(function (format) {
    ...
    TimePicker.prototype.render = function () {
        ...
        return React.createElement(Warp$1, null, splitFormat.map(function (item) {
            return React.createElement("span", { key: item }, React.createElement(TimeInput, __assign({ format: item }, _this.formatStep(item), { onChange: _this.handleOnChange, timePickerOnOpenChange: timePickerOnOpenChange, datePickerOnOpenChange: datePickerOnOpenChange })), _this.formatRender(item));
        }));
    };
...
var SingleDatePicker = /** @class */function (_super) {
    ...
    function SingleDatePicker(props) {
        ...
        _this.renderExtraFooter = function () {
            ...
            if (timeFormat) {
                ...
                return React.createElement(RenderTimeWarp, null, React.createElement(TimePicker, { format: timeFormat, disabledHours: _this.disabledHours, disabledMinutes: _this.disabledMinutes, disabledSeconds: _this.disabledSeconds, timePickerOnOpenChange: _this.timePickOnOpenChange, datePickerOnOpenChange: _this.onOpenChange, timeOnChange: _this.timeOnChange, value: value || defaultPickerValue || currentDate }), React.createElement(_Button, { size: "small", type: "primary", onClick: _this.pickerConfirm }, "\u786E\u5B9A"));
            }
            return null;
        };
        // 时间组件 数值变化回调
    ...
    SingleDatePicker.prototype.render = function () {
        ...
        return React.createElement(PackDataPick, __assign({ format: format }, extendsPlaceholder, { value: transformMoment(value), getCalendarContainer: getCalendarContainer, onOpenChange: this.onOpenChange, disabled: disabled, allowClear: allowClear, onChange: this.onChange,
            // @ts-ignore
...
(function (global, factory) {
   ...
   factory(global.moment);
    ...
    var zhCn = moment$$1.defineLocale('zh-cn', {
